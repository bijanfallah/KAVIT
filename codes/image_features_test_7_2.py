...
'''
file_name='/media/fallah/ext01/train_figs/test_features_2'
images_path = '/media/fallah/ext01/test_figs/data/competition_files/test_jpg/'
...
inputs_dir = "/media/fallah/ext01/train_figs/" # where the pre-trained models are
